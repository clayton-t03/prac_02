...
numbers_bigger_than_9 = [number for number in numbers if number > 9]
...
full_names_bigger_than_11 = [name for name in full_names if len(name) > 11]

last_names_big = []
for name in full_names_bigger_than_11:
    last_names_big.append(name.split()[-1])

last_names_big = ', '.join(last_names_big)
print(last_names_big)
