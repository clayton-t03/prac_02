...
def repeat_string(s, n):
    ...
    repeated_string = " ".join(s for i in range(n))
...
def run_tests():
    ...
    assert test_car.fuel == 10, "Car doesn't add fuel correctly"
    test_car.drive(20)
    assert test_car.fuel == 0, "Car doesn't use fuel correctly"
...
print(phrase_to_sentence('my name is Clayton'))
